...
\documentclass[11pt,a4paper,oneside,french]{article}
\pagestyle{plain}
...
\begin{document}
	...
	\include{data/1-introduction}
	
	\include{data/2-communication-chimique}
	
	\include{data/3-communication-ultrasonore}
	
	\include{data/4-communication-vibratoire}
	
	\include{data/5-conclusion}
