...
{% include image.html url="{{ site.url }}/img/SignalSpiders.png" description="Vibrations émises par un mâle *Tegenaria parietina* dans la toile. (dans B. et B. , 1979 @krafft_perception_1979) A : trémulations abdominales ; K : percussions avec l’abdomen" %}
