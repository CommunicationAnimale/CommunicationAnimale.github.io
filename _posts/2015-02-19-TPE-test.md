...
sociale<span data-label="fig:toileSociale"></span>](data/toileSociale)
...
data-label="fig:anatomiearaignee"></span>](data/anatomie_araignee)
...
data-label="fig:SignalSpiders"></span>](data/SignalSpiders)
