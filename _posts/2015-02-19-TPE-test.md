...
{% includeimage.html img="/img/toileSociale.jpg" caption="Toile d’une société d’<em>Anolesimius Eximius</em>, espèce d’araignée sociale" %}
...
{% includeimage.html img="/img/anatomie_araignee.jpg" caption="Anatomie d’une araignée" %}
...
{% includeimage.html img="img/SignalSpiders.png" caption="Vibrations émises par un mâle <em>Tegenaria parietina</em> dans la toile." %}
