...
sociale<span data-label="fig:toileSociale"></span>](/img/toileSociale.jpg)
...
{% include image.html
            img="{{site.url}}img/SignalSpiders.png"
            title="Vibrations émises par un mâle *Tegenaria parietina* dans la toile."
            caption="Vibrations émises par un mâle *Tegenaria parietina* dans la toile." %}
