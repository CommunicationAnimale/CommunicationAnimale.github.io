...
Exemple de phéromones de piste que nous avons modélisées grâce au logiciel ChemSketch, il faut noter que ce logiciel ne prend pas en compte les liaisons
